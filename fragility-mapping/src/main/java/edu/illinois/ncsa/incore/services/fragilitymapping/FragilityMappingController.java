...
public class FragilityMappingController {
    ...
    @RequestMapping(value = "/mapping/dataset/{mappingsetId}/{datasetId}")
    public Map<String, String> getMappings(@PathVariable("mappingsetId") String mappingsetId, @PathVariable("datasetId") String datasetId) {
    ...
    @RequestMapping(value = "/mapping/byurl")
    public Map<String, String> getMappings(@RequestParam("mappingUrl") String mappingUrl, @RequestParam("datasetUrl") String datasetUrl, @RequestParam("options") String optionsJson) {
