...
import SemanticModels.Units.Model.Derived.ReciprocalDerivedUnit;
import SemanticModels.Units.Model.NamedDerivedUnit;
...
public class SIDerivedUnits {
    ...
    public static final DivisionDerivedUnit metrePerSecondCubed = new DivisionDerivedUnit(SIUnits.metre, cubicSecond,
                                                                                          Dimensions.jerk);
    ...
    public static final ProductDerivedUnit newtonSecond = new ProductDerivedUnit(newton, SIUnits.second,
                                                                                 Dimensions.momentum);

    public static final ProductDerivedUnit newtonMetre = new ProductDerivedUnit(newton, SIUnits.metre,
                                                                                Dimensions.torque);
    ...
    public static final DivisionDerivedUnit newtonPerSecond = new DivisionDerivedUnit(newton, SIUnits.second,
                                                                                      Dimensions.yank);
    ...
    public static final DivisionDerivedUnit molePerCubicMetre = new DivisionDerivedUnit(SIUnits.mole, cubicMetre,
                                                                                        Dimensions.molarity);

    public static final DivisionDerivedUnit cubicMetrePerMole = new DivisionDerivedUnit(cubicMetre, SIUnits.mole,
                                                                                        Dimensions.molarVolume);

    public static final ProductDerivedUnit jouleSecond = new ProductDerivedUnit(joule, SIUnits.second,
                                                                                Dimensions.action);

    public static final DivisionDerivedUnit joulePerKelvin = new DivisionDerivedUnit(joule, SIUnits.kelvin,
                                                                                     Dimensions.entropy);
    ...
    public static final DivisionDerivedUnit joulePerMole = new DivisionDerivedUnit(joule, SIUnits.mole,
                                                                                   Dimensions.molarEnergy);

    public static final DivisionDerivedUnit joulePerKilogram = new DivisionDerivedUnit(joule, SIUnits.kilogram,
                                                                                       Dimensions.specificEnergy);

    public static final DivisionDerivedUnit joulePerCubicMetre = new DivisionDerivedUnit(joule, cubicMetre,
                                                                                         Dimensions.energyDensity);

    public static final DivisionDerivedUnit newtonPerMetre = new DivisionDerivedUnit(newton, SIUnits.metre,
                                                                                     Dimensions.stiffness);

    public static final DivisionDerivedUnit wattPerSquareMetre = new DivisionDerivedUnit(watt, squareMetre,
                                                                                         Dimensions.irradiance);

    //public static final DivisionDerivedUnit wattPerMetreKelvin = new DivisionDerivedUnit();

    public static final ProductDerivedUnit pascalSecond = new ProductDerivedUnit(pascal, SIUnits.second,
    ...
    public static final ReciprocalDerivedUnit reciprocalPascal = new ReciprocalDerivedUnit(pascal,
                                                                                           Dimensions.compressibility);

    public static final ReciprocalDerivedUnit reciprocalHenry = new ReciprocalDerivedUnit(henry,
                                                                                          Dimensions.magneticReluctance);
    ...
    public static final ProductDerivedUnit weberMetre = new ProductDerivedUnit(weber, SIUnits.metre,
                                                                               Dimensions.magneticMoment);

    public static final ProductDerivedUnit teslaMetre = new ProductDerivedUnit(tesla, SIUnits.metre,
                                                                               Dimensions.magneticRigidity);

    public static final DivisionDerivedUnit joulePerSquareMetre = new DivisionDerivedUnit(joule, squareMetre,
    ...
    public static final DivisionDerivedUnit hertzPerSecond = new DivisionDerivedUnit(hertz, SIUnits.second,
                                                                                     Dimensions.frequencyDrift);

    public static final DivisionDerivedUnit lumenPerWatt = new DivisionDerivedUnit(lumen, watt,
                                                                                   Dimensions.luminousEfficacy);

    public static final ProductDerivedUnit ampereRadian = new ProductDerivedUnit(SIUnits.ampere, radian,
                                                                                 Dimensions.magnetomotiveForce);
    ...
    public static final DivisionDerivedUnit wattPerSteradian = new DivisionDerivedUnit(watt, steradian,
                                                                                       Dimensions.radiantIntensity);
    ...
    public static final DivisionDerivedUnit wattPerMetre = new DivisionDerivedUnit(watt, SIUnits.metre,
                                                                                   Dimensions.spectralPower);
}
