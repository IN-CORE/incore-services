 ...
 * <p>
 * <p>Java class for RepresentedVariableGroupType complex type.
 * <p>
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;complexType name="RepresentedVariableGroupType"&gt;
 *   &lt;complexContent&gt;
 *     &lt;extension base="{ddi:reusable:3_2}VersionableType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element ref="{ddi:logicalproduct:3_2}TypeOfRepresentedVariableGroup" minOccurs="0"/&gt;
 *         &lt;element ref="{ddi:logicalproduct:3_2}RepresentedVariableGroupName" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "RepresentedVariableGroupType", propOrder = {
        ...
        "subject",
        "keyword",
        "representedVariableReferenceOrRepresentedVariableGroupReference"
})
public class RepresentedVariableGroupType
        extends VersionableType {

    @XmlElement(name = "TypeOfRepresentedVariableGroup")
    protected CodeValueType typeOfRepresentedVariableGroup;
    @XmlElement(name = "RepresentedVariableGroupName")
    protected List<NameType> representedVariableGroupName;
    ...
    @XmlElementRefs({
            @XmlElementRef(name = "RepresentedVariableGroupReference", namespace = "ddi:logicalproduct:3_2", type = JAXBElement.class, required = false),
            @XmlElementRef(name = "RepresentedVariableReference", namespace = "ddi:logicalproduct:3_2", type = JAXBElement.class, required = false)
    })
    protected List<JAXBElement<ReferenceType>> representedVariableReferenceOrRepresentedVariableGroupReference;
    ...
    public CodeValueType getTypeOfRepresentedVariableGroup() {
        return typeOfRepresentedVariableGroup;
    }

    /**
     * Sets the value of the typeOfRepresentedVariableGroup property.
     *
     * @param value allowed object is
     *              {@link CodeValueType }
     */
    public void setTypeOfRepresentedVariableGroup(CodeValueType value) {
        this.typeOfRepresentedVariableGroup = value;
    }

    /**
     * A name for the group. May be expressed in multiple languages. Repeat the element to express names with different content, for example different names for different systems.Gets the value of the representedVariableGroupName property.
     * <p>
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the representedVariableGroupName property.
     * <p>
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRepresentedVariableGroupName().add(newItem);
     * </pre>
     * <p>
     * <p>
     * <p>
     ...
     * {@link NameType }
     */
    public List<NameType> getRepresentedVariableGroupName() {
        if (representedVariableGroupName == null) {
            representedVariableGroupName = new ArrayList<NameType>();
        }
        return this.representedVariableGroupName;
    }

    /**
     * A display label for the RepresentedVariableGroup. May be expressed in multiple languages. Repeat for labels with different content, for example, labels with differing length limitations.Gets the value of the label property.
     * <p>
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
    ...
    /**
     * Gets the value of the representedVariableReferenceOrRepresentedVariableGroupReference property.
     * <p>
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the representedVariableReferenceOrRepresentedVariableGroupReference property.
     * <p>
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRepresentedVariableReferenceOrRepresentedVariableGroupReference().add(newItem);
     * </pre>
     * <p>
     * <p>
     * <p>
     ...
     * {@link JAXBElement }{@code <}{@link ReferenceType }{@code >}
     */
    public List<JAXBElement<ReferenceType>> getRepresentedVariableReferenceOrRepresentedVariableGroupReference() {
        if (representedVariableReferenceOrRepresentedVariableGroupReference == null) {
            representedVariableReferenceOrRepresentedVariableGroupReference = new ArrayList<JAXBElement<ReferenceType>>();
        }
        return this.representedVariableReferenceOrRepresentedVariableGroupReference;
    }
