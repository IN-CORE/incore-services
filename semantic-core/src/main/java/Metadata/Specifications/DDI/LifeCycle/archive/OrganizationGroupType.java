 ...
 * <p>
 * <p>Java class for OrganizationGroupType complex type.
 * <p>
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;complexType name="OrganizationGroupType"&gt;
 *   &lt;complexContent&gt;
 *     &lt;extension base="{ddi:reusable:3_2}VersionableType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element ref="{ddi:archive:3_2}TypeOfOrganizationGroup" minOccurs="0"/&gt;
 *         &lt;element ref="{ddi:archive:3_2}OrganizationGroupName" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "OrganizationGroupType", propOrder = {
        ...
        "subject",
        "keyword",
        "organizationReferenceOrIndividualReferenceOrRelationReference"
})
public class OrganizationGroupType extends VersionableType {

    @XmlElement(name = "TypeOfOrganizationGroup")
    protected CodeValueType typeOfOrganizationGroup;
    @XmlElement(name = "OrganizationGroupName")
    protected List<NameType> organizationGroupName;
    ...
    @XmlElementRefs({
            @XmlElementRef(name = "OrganizationReference", namespace = "ddi:archive:3_2", type = JAXBElement.class, required = false),
            @XmlElementRef(name = "IndividualReference", namespace = "ddi:archive:3_2", type = JAXBElement.class, required = false),
            @XmlElementRef(name = "OrganizationGroupReference", namespace = "ddi:archive:3_2", type = JAXBElement.class, required = false),
            @XmlElementRef(name = "RelationReference", namespace = "ddi:archive:3_2", type = JAXBElement.class, required = false)
    })
    protected List<JAXBElement<ReferenceType>> organizationReferenceOrIndividualReferenceOrRelationReference;
     ...
     * {@link CodeValueType }
     */
    public CodeValueType getTypeOfOrganizationGroup() {
        return typeOfOrganizationGroup;
    }

    /**
     * Sets the value of the typeOfOrganizationGroup property.
     *
     * @param value allowed object is
     *              {@link CodeValueType }
     */
    public void setTypeOfOrganizationGroup(CodeValueType value) {
        this.typeOfOrganizationGroup = value;
    }

    /**
     * A name for the group. May be expressed in multiple languages. Repeat the element to express names with different content, for example different names for different systems.Gets the value of the organizationGroupName property.
     * <p>
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the organizationGroupName property.
     * <p>
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getOrganizationGroupName().add(newItem);
     * </pre>
     * <p>
     * <p>
     * <p>
     ...
     * {@link NameType }
     */
    public List<NameType> getOrganizationGroupName() {
        if (organizationGroupName == null) {
            organizationGroupName = new ArrayList<NameType>();
        }
        return this.organizationGroupName;
    }

    /**
     * A display label for the OrganizationGroup. May be expressed in multiple languages. Repeat for labels with different content, for example, labels with differing length limitations.Gets the value of the label property.
     * <p>
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
    ...
    /**
     * Gets the value of the organizationReferenceOrIndividualReferenceOrRelationReference property.
     * <p>
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the organizationReferenceOrIndividualReferenceOrRelationReference property.
     * <p>
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getOrganizationReferenceOrIndividualReferenceOrRelationReference().add(newItem);
     * </pre>
     * <p>
     * <p>
     * <p>
     ...
     * {@link JAXBElement }{@code <}{@link ReferenceType }{@code >}
     */
    public List<JAXBElement<ReferenceType>> getOrganizationReferenceOrIndividualReferenceOrRelationReference() {
        if (organizationReferenceOrIndividualReferenceOrRelationReference == null) {
            organizationReferenceOrIndividualReferenceOrRelationReference = new ArrayList<JAXBElement<ReferenceType>>();
        }
        return this.organizationReferenceOrIndividualReferenceOrRelationReference;
    }
