 ...
 * <p>
 * <p>Java class for InstructionGroupType complex type.
 * <p>
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;complexType name="InstructionGroupType"&gt;
 *   &lt;complexContent&gt;
 *     &lt;extension base="{ddi:reusable:3_2}VersionableType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element ref="{ddi:datacollection:3_2}TypeOfInstructionGroup" minOccurs="0"/&gt;
 *         &lt;element ref="{ddi:datacollection:3_2}InstructionGroupName" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "InstructionGroupType", propOrder = {
        ...
        "subject",
        "keyword",
        "instructionReferenceOrInstructionGroupReference"
})
public class InstructionGroupType
        extends VersionableType {

    @XmlElement(name = "TypeOfInstructionGroup")
    protected CodeValueType typeOfInstructionGroup;
    @XmlElement(name = "InstructionGroupName")
    protected List<NameType> instructionGroupName;
    ...
    @XmlElementRefs({
            @XmlElementRef(name = "InstructionGroupReference", namespace = "ddi:datacollection:3_2", type = JAXBElement.class, required = false),
            @XmlElementRef(name = "InstructionReference", namespace = "ddi:datacollection:3_2", type = JAXBElement.class, required = false)
    })
    protected List<JAXBElement<ReferenceType>> instructionReferenceOrInstructionGroupReference;
     ...
     * {@link CodeValueType }
     */
    public CodeValueType getTypeOfInstructionGroup() {
        return typeOfInstructionGroup;
    }

    /**
     * Sets the value of the typeOfInstructionGroup property.
     *
     * @param value allowed object is
     *              {@link CodeValueType }
     */
    public void setTypeOfInstructionGroup(CodeValueType value) {
        this.typeOfInstructionGroup = value;
    }

    /**
     * A name for the group. May be expressed in multiple languages. Repeat the element to express names with different content, for example different names for different systems.Gets the value of the instructionGroupName property.
     * <p>
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the instructionGroupName property.
     * <p>
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getInstructionGroupName().add(newItem);
     * </pre>
     * <p>
     * <p>
     * <p>
     ...
     * {@link NameType }
     */
    public List<NameType> getInstructionGroupName() {
        if (instructionGroupName == null) {
            instructionGroupName = new ArrayList<NameType>();
        }
        return this.instructionGroupName;
    }

    /**
     * A display label for the InstructionGroup. May be expressed in multiple languages. Repeat for labels with different content, for example, labels with differing length limitations.Gets the value of the label property.
     * <p>
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
    ...
    /**
     * Gets the value of the instructionReferenceOrInstructionGroupReference property.
     * <p>
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the instructionReferenceOrInstructionGroupReference property.
     * <p>
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getInstructionReferenceOrInstructionGroupReference().add(newItem);
     * </pre>
     * <p>
     * <p>
     * <p>
     ...
     * {@link JAXBElement }{@code <}{@link ReferenceType }{@code >}
     */
    public List<JAXBElement<ReferenceType>> getInstructionReferenceOrInstructionGroupReference() {
        if (instructionReferenceOrInstructionGroupReference == null) {
            instructionReferenceOrInstructionGroupReference = new ArrayList<JAXBElement<ReferenceType>>();
        }
        return this.instructionReferenceOrInstructionGroupReference;
    }
