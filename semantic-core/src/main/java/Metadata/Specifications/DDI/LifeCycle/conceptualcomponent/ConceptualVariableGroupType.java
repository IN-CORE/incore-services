 ...
 * <p>
 * <p>Java class for ConceptualVariableGroupType complex type.
 * <p>
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;complexType name="ConceptualVariableGroupType"&gt;
 *   &lt;complexContent&gt;
 *     &lt;extension base="{ddi:reusable:3_2}VersionableType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element ref="{ddi:conceptualcomponent:3_2}TypeOfConceptualVariableGroup" minOccurs="0"/&gt;
 *         &lt;element ref="{ddi:conceptualcomponent:3_2}ConceptualVariableGroupName" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "ConceptualVariableGroupType", propOrder = {
        ...
        "subject",
        "keyword",
        "conceptualVariableReferenceOrConceptualVariableGroupReference"
})
public class ConceptualVariableGroupType
        extends VersionableType {

    @XmlElement(name = "TypeOfConceptualVariableGroup")
    protected CodeValueType typeOfConceptualVariableGroup;
    @XmlElement(name = "ConceptualVariableGroupName")
    protected List<NameType> conceptualVariableGroupName;
    ...
    @XmlElementRefs({
            @XmlElementRef(name = "ConceptualVariableGroupReference", namespace = "ddi:conceptualcomponent:3_2", type = JAXBElement.class, required = false),
            @XmlElementRef(name = "ConceptualVariableReference", namespace = "ddi:reusable:3_2", type = JAXBElement.class, required = false)
    })
    protected List<JAXBElement<ReferenceType>> conceptualVariableReferenceOrConceptualVariableGroupReference;
     ...
     * {@link CodeValueType }
     */
    public CodeValueType getTypeOfConceptualVariableGroup() {
        return typeOfConceptualVariableGroup;
    }

    /**
     * Sets the value of the typeOfConceptualVariableGroup property.
     *
     * @param value allowed object is
     *              {@link CodeValueType }
     */
    public void setTypeOfConceptualVariableGroup(CodeValueType value) {
        this.typeOfConceptualVariableGroup = value;
    }

    /**
     * A name for the group. May be expressed in multiple languages. Repeat the element to express names with different content, for example different names for different systems.Gets the value of the conceptualVariableGroupName property.
     * <p>
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the conceptualVariableGroupName property.
     * <p>
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getConceptualVariableGroupName().add(newItem);
     * </pre>
     * <p>
     * <p>
     * <p>
     ...
     * {@link NameType }
     */
    public List<NameType> getConceptualVariableGroupName() {
        if (conceptualVariableGroupName == null) {
            conceptualVariableGroupName = new ArrayList<NameType>();
        }
        return this.conceptualVariableGroupName;
    }

    /**
     * A display label for the ConceptualVariableGroup. May be expressed in multiple languages. Repeat for labels with different content, for example, labels with differing length limitations.Gets the value of the label property.
     * <p>
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
    ...
    /**
     * Reference to the universe statement describing the persons or other objects to which the contents of this group pertain. TypeOfObject should be set to Universe.Gets the value of the universeReference property.
     * <p>
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
    ...
    /**
     * Gets the value of the conceptualVariableReferenceOrConceptualVariableGroupReference property.
     * <p>
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the conceptualVariableReferenceOrConceptualVariableGroupReference property.
     * <p>
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getConceptualVariableReferenceOrConceptualVariableGroupReference().add(newItem);
     * </pre>
     * <p>
     * <p>
     * <p>
     ...
     * {@link JAXBElement }{@code <}{@link ReferenceType }{@code >}
     */
    public List<JAXBElement<ReferenceType>> getConceptualVariableReferenceOrConceptualVariableGroupReference() {
        if (conceptualVariableReferenceOrConceptualVariableGroupReference == null) {
            conceptualVariableReferenceOrConceptualVariableGroupReference = new ArrayList<JAXBElement<ReferenceType>>();
        }
        return this.conceptualVariableReferenceOrConceptualVariableGroupReference;
    }
