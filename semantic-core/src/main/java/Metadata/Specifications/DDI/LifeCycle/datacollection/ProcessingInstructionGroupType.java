 ...
 * <p>
 * <p>Java class for ProcessingInstructionGroupType complex type.
 * <p>
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;complexType name="ProcessingInstructionGroupType"&gt;
 *   &lt;complexContent&gt;
 *     &lt;extension base="{ddi:reusable:3_2}VersionableType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element ref="{ddi:datacollection:3_2}TypeOfProcessingInstructionGroup" minOccurs="0"/&gt;
 *         &lt;element ref="{ddi:datacollection:3_2}ProcessingInstructionGroupName" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "ProcessingInstructionGroupType", propOrder = {
        ...
        "subject",
        "keyword",
        "generalInstructionReferenceOrGenerationInstructionReferenceOrProcessingInstructionGroupReference"
})
public class ProcessingInstructionGroupType
        extends VersionableType {

    @XmlElement(name = "TypeOfProcessingInstructionGroup")
    protected CodeValueType typeOfProcessingInstructionGroup;
    @XmlElement(name = "ProcessingInstructionGroupName")
    protected List<NameType> processingInstructionGroupName;
    ...
    @XmlElementRefs({
            @XmlElementRef(name = "ProcessingInstructionGroupReference", namespace = "ddi:datacollection:3_2", type = JAXBElement.class, required = false),
            @XmlElementRef(name = "GenerationInstructionReference", namespace = "ddi:datacollection:3_2", type = JAXBElement.class, required = false),
            @XmlElementRef(name = "GeneralInstructionReference", namespace = "ddi:datacollection:3_2", type = JAXBElement.class, required = false)
    })
    protected List<JAXBElement<ReferenceType>> generalInstructionReferenceOrGenerationInstructionReferenceOrProcessingInstructionGroupReference;
     ...
     * {@link CodeValueType }
     */
    public CodeValueType getTypeOfProcessingInstructionGroup() {
        return typeOfProcessingInstructionGroup;
    }

    /**
     * Sets the value of the typeOfProcessingInstructionGroup property.
     *
     * @param value allowed object is
     *              {@link CodeValueType }
     */
    public void setTypeOfProcessingInstructionGroup(CodeValueType value) {
        this.typeOfProcessingInstructionGroup = value;
    }

    /**
     * A name for the ProcessingInstructionGroup. May be expressed in multiple languages. Repeat the element to express names with different content, for example different names for different systems.Gets the value of the processingInstructionGroupName property.
     * <p>
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the processingInstructionGroupName property.
     * <p>
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getProcessingInstructionGroupName().add(newItem);
     * </pre>
     * <p>
     * <p>
     * <p>
     ...
     * {@link NameType }
     */
    public List<NameType> getProcessingInstructionGroupName() {
        if (processingInstructionGroupName == null) {
            processingInstructionGroupName = new ArrayList<NameType>();
        }
        return this.processingInstructionGroupName;
    }

    /**
     * A display label for the ProcessingInstructionGroup. May be expressed in multiple languages. Repeat for labels with different content, for example, labels with differing length limitations.Gets the value of the label property.
     * <p>
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
    ...
    /**
     * Gets the value of the generalInstructionReferenceOrGenerationInstructionReferenceOrProcessingInstructionGroupReference property.
     * <p>
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the generalInstructionReferenceOrGenerationInstructionReferenceOrProcessingInstructionGroupReference property.
     * <p>
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getGeneralInstructionReferenceOrGenerationInstructionReferenceOrProcessingInstructionGroupReference().add(newItem);
     * </pre>
     * <p>
     * <p>
     * <p>
     ...
     * {@link JAXBElement }{@code <}{@link ReferenceType }{@code >}
     */
    public List<JAXBElement<ReferenceType>> getGeneralInstructionReferenceOrGenerationInstructionReferenceOrProcessingInstructionGroupReference() {
        if (generalInstructionReferenceOrGenerationInstructionReferenceOrProcessingInstructionGroupReference == null) {
            generalInstructionReferenceOrGenerationInstructionReferenceOrProcessingInstructionGroupReference = new ArrayList<JAXBElement<ReferenceType>>();
        }
        return this.generalInstructionReferenceOrGenerationInstructionReferenceOrProcessingInstructionGroupReference;
    }
