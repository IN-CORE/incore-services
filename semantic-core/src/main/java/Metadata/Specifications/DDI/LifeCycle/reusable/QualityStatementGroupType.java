 ...
 * <p>
 * <p>Java class for QualityStatementGroupType complex type.
 * <p>
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;complexType name="QualityStatementGroupType"&gt;
 *   &lt;complexContent&gt;
 *     &lt;extension base="{ddi:reusable:3_2}VersionableType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element ref="{ddi:reusable:3_2}TypeOfQualityStatementGroup" minOccurs="0"/&gt;
 *         &lt;element ref="{ddi:reusable:3_2}QualityStatementGroupName" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "QualityStatementGroupType", propOrder = {
        ...
        "subject",
        "keyword",
        "qualityStatementReferenceOrQualityStatementGroupReference"
})
public class QualityStatementGroupType
        extends VersionableType {

    @XmlElement(name = "TypeOfQualityStatementGroup")
    protected CodeValueType typeOfQualityStatementGroup;
    @XmlElement(name = "QualityStatementGroupName")
    protected List<NameType> qualityStatementGroupName;
    ...
    @XmlElementRefs({
            @XmlElementRef(name = "QualityStatementGroupReference", namespace = "ddi:reusable:3_2", type = JAXBElement.class, required = false),
            @XmlElementRef(name = "QualityStatementReference", namespace = "ddi:reusable:3_2", type = JAXBElement.class, required = false)
    })
    protected List<JAXBElement<ReferenceType>> qualityStatementReferenceOrQualityStatementGroupReference;
     ...
     * {@link CodeValueType }
     */
    public CodeValueType getTypeOfQualityStatementGroup() {
        return typeOfQualityStatementGroup;
    }

    /**
     * Sets the value of the typeOfQualityStatementGroup property.
     *
     * @param value allowed object is
     *              {@link CodeValueType }
     */
    public void setTypeOfQualityStatementGroup(CodeValueType value) {
        this.typeOfQualityStatementGroup = value;
    }

    /**
     * A name for the group. May be expressed in multiple languages. Repeat the element to express names with different content, for example different names for different systems.Gets the value of the qualityStatementGroupName property.
     * <p>
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the qualityStatementGroupName property.
     * <p>
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getQualityStatementGroupName().add(newItem);
     * </pre>
     * <p>
     * <p>
     * <p>
     ...
     * {@link NameType }
     */
    public List<NameType> getQualityStatementGroupName() {
        if (qualityStatementGroupName == null) {
            qualityStatementGroupName = new ArrayList<NameType>();
        }
        return this.qualityStatementGroupName;
    }

    /**
     * A display label for the QualityStatementGroup. May be expressed in multiple languages. Repeat for labels with different content, for example, labels with differing length limitations.Gets the value of the label property.
     * <p>
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
    ...
    /**
     * Gets the value of the qualityStatementReferenceOrQualityStatementGroupReference property.
     * <p>
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the qualityStatementReferenceOrQualityStatementGroupReference property.
     * <p>
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getQualityStatementReferenceOrQualityStatementGroupReference().add(newItem);
     * </pre>
     * <p>
     * <p>
     * <p>
     ...
     * {@link JAXBElement }{@code <}{@link ReferenceType }{@code >}
     */
    public List<JAXBElement<ReferenceType>> getQualityStatementReferenceOrQualityStatementGroupReference() {
        if (qualityStatementReferenceOrQualityStatementGroupReference == null) {
            qualityStatementReferenceOrQualityStatementGroupReference = new ArrayList<JAXBElement<ReferenceType>>();
        }
        return this.qualityStatementReferenceOrQualityStatementGroupReference;
    }
