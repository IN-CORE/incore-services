 ...
 *         &lt;element ref="{ddi:physicaldataproduct_ncube_inline:3_2}AttachedAttribute" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{ddi:physicaldataproduct_ncube_inline:3_2}Measure" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
...
public class DataItemType {
    ...
    /**
     * Identifies the specific measure of the cell by noting the order value of the measure within the MeasureDimension and the value for the measure.Gets the value of the measure property.
     * <p>
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
    ...
    /**
     * Use to indicate the language of the data values for this item.
     *
