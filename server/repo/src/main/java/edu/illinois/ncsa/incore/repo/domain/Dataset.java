package edu.illinois.ncsa.incore.repo.domain;
...
import edu.illinois.ncsa.incore.repo.domain.AbstractBean;
import edu.illinois.ncsa.incore.repo.domain.jackson.JsonDateSerializer;
