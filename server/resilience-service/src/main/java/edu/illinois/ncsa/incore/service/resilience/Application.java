...
package edu.illinois.ncsa.incore.service.resilience;
...
import edu.illinois.ncsa.incore.service.resilience.daos.*;
...
public class Application extends ResourceConfig {
    ...
    public Application() {
        String mongodbUri = "mongodb://localhost:27017/resiliencedb";

        String mongodbUriProp = Config.getConfigProperties().getProperty("resilience.mongodbURI");
