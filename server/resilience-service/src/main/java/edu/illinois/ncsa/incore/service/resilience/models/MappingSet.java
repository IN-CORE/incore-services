...
import edu.illinois.ncsa.incore.service.resilience.models.mapping.PropertyMatch;
...
@JsonSubTypes({@JsonSubTypes.Type(value = FragilityMappingSet.class, name = "resilience"),
