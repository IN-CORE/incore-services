...
public class FragilityController {
    ...
    public List<FragilitySet> getFragilities(@HeaderParam("X-Credential-Username") String username,
                                             ...
                                             @ApiParam(value = "Legacy resilience Id from v1") @QueryParam("legacy_id") String legacyId,
    ...
    @Produces({MediaType.APPLICATION_JSON})
    @ApiOperation(value = "Create a resilience set", notes="Post a resilience set to the resilience service")
    public FragilitySet uploadFragilitySet(@HeaderParam("X-Credential-Username") String username,
                                           @ApiParam(value="json representing the resilience set") FragilitySet fragilitySet) {
    ...
    @Path("{fragilityId}")
    @Produces({MediaType.APPLICATION_JSON})
    @ApiOperation(value = "Gets a resilience by Id", notes="Get a particular resilience based on the id provided")
    public FragilitySet getFragilityById(@HeaderParam("X-Credential-Username") String username,
                                         @ApiParam(value="hexadecimal resilience id", example = "5b47b2d8337d4a36187c6727") @PathParam("fragilityId") String id) {
