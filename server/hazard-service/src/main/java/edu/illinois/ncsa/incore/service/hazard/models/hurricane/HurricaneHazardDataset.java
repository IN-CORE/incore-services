...
@JsonSubTypes({@JsonSubTypes.Type(value = ProbabilisticHurricaneHazard.class, name = "probabilistic"), @JsonSubTypes.Type(value =
    DeterministicHurricaneHazard.class, name = "deterministic")})
@Embedded
