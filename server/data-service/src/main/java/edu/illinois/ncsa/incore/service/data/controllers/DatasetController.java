...
public class DatasetController {
    ...
    public List<Dataset> getDatasets(@HeaderParam("x-auth-userinfo") String userInfo,
    ...
    public Response getFileByFileDescriptor(@HeaderParam("x-auth-userinfo") String userInfo,
        ...
        try{
            File outFile = null;
            Dataset dataset = getDatasetbyId(userInfo, id);
    ...
    public FileDescriptor getFileByDatasetIdFileDescriptor(@HeaderParam("x-auth-userinfo") String userInfo,
                                                           @ApiParam(value = "Dataset Id from data service", required = true) @PathParam("id") String id,
                                                           @ApiParam(value = "FileDescriptor Object Id", required = true) @PathParam("file_id") String fileId) {
        if (userInfo == null || !JsonUtils.isJSONValid(userInfo)) {
            throw new BadRequestException("Invalid User Info!");
    ...
    public Dataset uploadFiles(@HeaderParam("x-auth-userinfo") String userInfo,
                               @ApiParam(value = "Dataset Id from data service", required = true) @PathParam("id") String datasetId,
        ...
        try{
            ...
            String inJson = "";
            String paramName = "";
            Dataset dataset = getDatasetbyId(userInfo, objIdStr);
    ...
    public Object updateObject(@HeaderParam("x-auth-userinfo") String userInfo,
                               @ApiParam(value = "Dataset Id from data service", required = true) @PathParam("id") String datasetId,
    ...
    public List<Dataset> findDatasets(@HeaderParam("x-auth-userinfo") String userInfo,
