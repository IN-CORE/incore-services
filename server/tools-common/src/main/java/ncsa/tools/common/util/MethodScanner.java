...
public class MethodScanner extends AbstractScanner {
     ...
     *
     * @param mp TrebuchetMethodPattern to use in connection with this scanner.
     * @throws ScanException
     * @throws NCSAException if class is not found.
     */
     ...
     *
     * @throws ScanException
     * @throws NCSAException if scanning fails.
     */
    ...
    /**
     * @param b if true, sort the list of methods
    ...
    /**
     * @param methodModifiers bit-wise value for method.
     * @param include         whether this is an include or exclude match.
    ...
    /**
     * @param method to check for parameter number and types.
     ...
     *
     * @throws NCSAException if an inconsistent setting is encountered.
     */
     ...
     *
     * @param index pointing to the data structure.
     * @param s     array of objects to set.
     */
     ...
     *
     * @param s modifier types.
     * @return wrapped Modifier code value.
     * @throws NCSAException if type is not valid.
     */
     ...
     *
     * @param s array of fully qualified name strings.
     ...
     *
     * @param methods array of methods to scan.
     */
