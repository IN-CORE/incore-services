...
public class MethodPattern {
    ...
    /**
     * @param s modifier to be included in a set, one element of which the
     *          method must have.
     */
    ...
    /**
     * @param s modifier to be included in a set, any element of which will
    ...
    /**
     * @param s modifier to be included in a set, all elements of which the
     *          method must have.
     */
    ...
    /**
     * @param s modifier to be included in a set disqualifying any method having
     *          all of its elements.
     */
    ...
    /**
     * @param s parameter type to match (must be added in order).
     */
    ...
    /**
     * @param s return type to match (can be more than one).
     */
    ...
    /**
     * @param s return type to exclude (can be more than one).
     */
    ...
    /**
     * @param s exception type to match (can be more than one).
     */
    ...
    /**
     * @param s exception type to exclude (can be more than one).
     */
