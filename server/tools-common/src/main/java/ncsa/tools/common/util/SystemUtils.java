...
public class SystemUtils {
     ...
     * "$A$B").
     *
     * @param args     the arguments conforming to the restrictions above;
     * @param env      definitions of the type "A=B";
     * @param failFast if true and an undefined variable name is enountered, will throw
     ...
     *
     * @param profile object with extra environment variable definitions; overrides
     ...
     *
     * @param b if true, sets System properties.
    ...
    /**
     * @param vars definitions of the type "A=B";
    ...
    /**
     * @param nvpairs map of name value pairs.
     ...
     *
     * @param sorted if true, keys are in sorted order.
    ...
    /**
     * @param vars array of property names.
     ...
     *
     * @param properties ncsa.common.types.Property list to check (in order).
     ...
     * Category of property can be "environment", "property", or <code>null</code>
     *
     * @param properties to check (in order).
     * @return path of working directory, or <code>null</code> if no definition
     * is found.
     */
    ...
    /**
     * @param options non-separated sequence of the following characters:
     *                <p>
     *                <p>
     *                a [= architecture];
     *                <p>
     ...
     * @param parsed  list for recording parsed information (can be null).
     ...
     *
     * @param permissions e.g. '755' or 'u+x'.
     ...
     *
     * @param permissions    e.g. '755' or 'u+x'.
     * @param pathExpression unix-style path regular expression.
     * @param recursive      if true, changes all matching subdirectories and files.
     * @throws FileNotFoundException if chmod executable not found
     */
     ...
     * @param pathExpression      unix-style path regular expression.
     * @param recursive           if true, changes all matching subdirectories and files.
     * @param alternateShellPaths to add to the default search list (/bin/sh, /usr/bin/sh).
     * @throws FileNotFoundException if chmod executable not found
     */
     ...
     * Creates tar archive.
     *
     * @param tarPath absolute path to tar file to be created.
     * @param path    a file or directory to be tar'd up.
     * @param verbose = -v
     * @param zip     = -z
     */
     ...
     *
     * @param tarPath    absolute path to tar file to be created.
     * @param tarBaseDir absolute path to dir in which to execute the tar command.
     * @param fileNames  list of names relative to base dir to be tar'd up.
     * @param verbose    = -v
     * @param zip        = -z
     */
     ...
     * @param tarPath          absolute path to tar file to be created.
     * @param tarBaseDir       absolute path to dir in which to execute the tar command.
     * @param sourceExpression Unix-style path expression for files to be tar'd up.
     * @param verbose          = -v
     * @param zip              = -z
     */
     ...
     * Unpacks tar archive.
     *
     * @param tarPath        absolute path to file to be untar'd.
     * @param destinationDir absolute path to dir in which to execute the tar command.
     * @param verbose        = -v
     * @param zip            = -z
     */
     ...
     *
     * @param path file on which to call tail -f
     ...
     * logger.
     *
     * @param pd process whose stream should be consumed.
     */
     ...
     *
     * @param reader for the input stream
     * @param err    if true, stream is an error stream.
     */
     ...
     *
     * @param reader     for the input stream
     * @param filePrefix log to file whose path is this prefix, with extension ".out" or ".err"
     * @param err        if true, stream is an error stream.
     */
     ...
     *
     * @param pd            process
     * @param streamThreads of the stream consumers
     */
     ...
     * @param rootPid    can be <code>null</code>
     * @param tagToMatch can be <code>null</code>
     * @param signal     can be <code>null</code>
     ...
     *
     * @param process presumably corresponding to the exec'd 'printenv' command.
     ...
     * List.
     *
     * @param b         if true, sets System.property( name, value ) for each parsed
     *                  line.
     * @param envBuffer containing the "name=value" substrings.
