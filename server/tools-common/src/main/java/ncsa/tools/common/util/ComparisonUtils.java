...
public class ComparisonUtils {
     ...
     * @param arg2       to compare to.
     * @param comparator to use.
     * @param cast       class to cast to (for primitive conversion; can be <code>null</code>).
    ...
    /**
     * @param comparatorValue int value.
     ...
     * @param clzz   to check against filter.
     ...
     *
     * @param filter to match.
     * @param type   to check against filter.
     ...
     *
     * @param filter     to match.
     * @param properties map of properties against which to match.
     ...
     * @param filter       to match.
     * @param properties   map of properties against which to match.
     * @param convertTypes whether to try to flexibly convert the types to match String/numeric values
     * @return if the filter is <code>null</code>, returns true; if the filter
     * is empty (no clauses), returns the negation of the filter's 'not'
     * field; if property map satisfies filter, returns true; else
     * returns false.
