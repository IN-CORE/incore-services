...
public class DateUtils {
     ...
     *
     * @param timeString string representing time in milliseconds.
     ...
     *
     * @param dateTime string representing date and time.
     * @param format   for dateTime string.
     * @return corresponding wrapper object.
     */
     ...
     *
     * @param millis date-time in milliseconds.
     ...
     *
     * @param date   object.
     * @param format string initializer.
     ...
     *
     * @param dateTime string representation of date.
     * @return date object.
     */
