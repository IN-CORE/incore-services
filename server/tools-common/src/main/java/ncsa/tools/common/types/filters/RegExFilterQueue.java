...
public class RegExFilterQueue {
    ...
    /**
     * @param i options: one of the OgreConstants ONE_TO_ONE, PRIORITY or
     *          MANY_TO_ONE.
     */
    ...
    /**
     * @param s options: "one-to-one" (default),
     *          "priority", "many-to-one".
     * @throws NCSAException if type is not one of the above options.
     */
    ...
    /**
     * @param filter to be processed (in order).
     */
     ...
     *
     * @param charSequence the stream sequence to check for match.
     */
     ...
     *
     * @param p_currIndex current index of the filter to be moved
     */
