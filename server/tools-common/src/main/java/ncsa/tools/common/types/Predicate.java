...
public class Predicate
{
	...
	/**
	 * @param s
	 *            Primitive Wrapper or String class to which the comparands should
	 *            be cast at runtime.
...
/**
	...
	/**
	 * @param i
	 *            options: one of the OgreConstants EQ, EQUALS, NE, NEQUALS, GT,
	 *            GE, LT, or LE.
	 */
...
/**
	 ...
	 * 
	 * @param s
	 *            options = (1) "length", "len", "l" [compares file lengths]; (2)
	...
	/**
	 * @param i
	 *            options: one of the NCSAConstants LENGTH, TIMESTAMP, PATH or
	 *            CONTENTS.
	 */
	...
	/**
	 * @param b
	 *            boolean value to use in comparison.
	 */
	...
	/**
	 * @param b
	 *            byte value to use in comparison.
	 */
	...
	/**
	 * @param c
	 *            char value to use in comparison.
	 */
	...
	/**
	 * @param d
	 *            double value to use in comparison.
	 */
	...
	/**
	 * @param f
	 *            float value to use in comparison.
	 */
	...
	/**
	 * @param i
	 *            int value to use in comparison.
	 */
	...
	/**
	 * @param l
	 *            long value to use in comparison.
	 */
	...
	/**
	 * @param s
	 *            short value to use in comparison.
	 */
	...
	/**
	 * @param s
	 *            String value to use in comparison.
	 */
	...
	/**
	 * @param s
	 *            name of System property whose value should be used in
	 *            comparison.
	 */
	 ...
	 *            of the predicate.
	 * @param convertTypes
	 *            whether it should attempt to flexibly convert types to match
	 * @return whether the predicate is valid (true) on the subject.
	 */
