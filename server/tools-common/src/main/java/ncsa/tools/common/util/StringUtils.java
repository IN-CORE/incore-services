...
public class StringUtils {
    ...
    /**
     * @param prefix to be discarded.
     * @param full   string from which to extract suffix.
     ...
     * @param prefixLength length of buffer to retain (-1 = ALL).
     * @param toAppend     new suffix.
     * @return concatenated result.
     * @throws IndexOutOfBoundsException if the indicated prefix length exceeds
     ...
     *
     * @param base  id to append to.
     * @param seqno suffix to use.
     * @return concatenated result.
     */
     ...
     *
     * @param prefix to use as id base.
     ...
     *
     * @param prefix       to use as id base.
     * @param useTimestamp if true, timestamp is included.
     * @param useHost      if true, host name is included.
     * @param useLong      if true, random is long (else, int).
     * @return id generated from prefix.
     */
    ...
    /**
     * @param number object representing a number.
     * @param places to the left of decimal to fill with zeros.
     ...
     *
     * @param sequence     to be tokenized.
     * @param chain        list of delimiters to use cyclically.
     * @param paired       process delimiters in pairs,
     *                     returning token between them
     * @param includeDelim append delimiter to token
     * @return List of token Strings.
     * @throws IllegalArgumentException if original String is null
     */
