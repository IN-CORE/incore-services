...
{
	public static final Class[] primitiveAssignable = { String.class, Boolean.TYPE, Byte.TYPE, Character.TYPE, Double.TYPE, Float.TYPE,
			Integer.TYPE, Long.TYPE, Short.TYPE, Boolean.class, Byte.class, Character.class, Double.class, Float.class, Integer.class,
			Long.class, Short.class, File.class, URI.class };
	...
	static {
		typeMap = new HashMap();
		String[] keys = new String[] { "bool", "boolean", "byte", "char", "character", "double", "float", "int", "integer", "long",
				"short", "void", "Boolean", "java.lang.Boolean", "Byte", "java.lang.Byte", "Character", "java.lang.Character", "Double",
				"java.lang.Double", "Float", "java.lang.Float", "Integer", "java.lang.Integer", "Long", "java.lang.Long", "Short",
				"java.lang.Short", "Void", "java.lang.Void", "string", "String", "java.lang.String", "file", "File", "java.io.File", "uri",
				"URI", "java.net.URI" };
		Class[] clazzes = new Class[] { Boolean.TYPE, Boolean.TYPE, Byte.TYPE, Character.TYPE, Character.TYPE, Double.TYPE, Float.TYPE,
				Integer.TYPE, Integer.TYPE, Long.TYPE, Short.TYPE, Void.TYPE, Boolean.class, Boolean.class, Byte.class, Byte.class,
				Character.class, Character.class, Double.class, Double.class, Float.class, Float.class, Integer.class, Integer.class,
				Long.class, Long.class, Short.class, Short.class, Void.class, Void.class, String.class, String.class, String.class,
		...
		clazzes = new Class[] { Boolean.class, Byte.class, Character.class, Double.class, Float.class, Integer.class, Long.class,
				Short.class, Void.class };
		Class[] types = new Class[] { Boolean.TYPE, Byte.TYPE, Character.TYPE, Double.TYPE, Float.TYPE, Integer.TYPE, Long.TYPE,
		...
		types = new Class[] { Double.TYPE, Float.TYPE, Integer.TYPE, Long.TYPE, Short.TYPE, Double.class, Float.class, Integer.class,
	...
	/**
	 * @param s
	 *            fully qualified or primitive name.
	 * 
	 ...
	 * 
	 */
	public static Class getClassForName(String s) throws ClassNotFoundException
	{
	 ...
	 * 
	 */
	public static boolean isTypeOf(String s, String toMatch) throws ClassNotFoundException
	{
	 ...
	 * 
	 */
	public static boolean isTypeOf(Class c, String toMatch) throws ClassNotFoundException
	{
	 ...
	 * 
	 */
	public static boolean isTypeOf(String s, Class toMatch) throws ClassNotFoundException
	{
	...
	public static boolean isTypeOf(Class c, Class toMatch)
	{
		...
		while (c != null) {
			matches = c.equals(toMatch) || (toMatch.equals(Boolean.TYPE) && c.equals(Boolean.class))
					|| (toMatch.equals(Byte.TYPE) && c.equals(Byte.class)) || (toMatch.equals(Character.TYPE) && c.equals(Character.class))
					|| (toMatch.equals(Double.TYPE) && c.equals(Double.class)) || (toMatch.equals(Float.TYPE) && c.equals(Float.class))
					|| (toMatch.equals(Integer.TYPE) && c.equals(Integer.class)) || (toMatch.equals(Long.TYPE) && c.equals(Long.class))
					|| (toMatch.equals(Short.TYPE) && c.equals(Short.class));
			if (matches)
				break;
			c = c.getSuperclass();
		}
	 ...
	 *            object to compare.
	 * @param o2
	 *            object to which o1 is compared.
	 * @param c1
	 *            class which should match the class of o1.
	 * @param c2
	 *            class which should match the class of o2.
	 * 
	 * @return true if match, false if not
	 * 
	 */
	public static boolean typesMatch(Object o1, Object o2, Class c1, Class c2)
	{
		...
		return ((c3.equals(c1) && c4.equals(c1)) || (c3.equals(c2) && c4.equals(c2)) || (c3.equals(c1) && c4.equals(c2)) || (c3.equals(c2) && c4
				.equals(c1)));
	} // typesMatch
	...
	public static boolean arePrimitiveAnalogous(Class c1, Class c2)
	{
		if (c1 == null || c2 == null)
			return false;
		return c1.equals(c2) || c1.equals(wrappers.get(c2)) || c1.equals(primTypes.get(c2));
	}

	public static Object cast(String castTo, Object value) throws TypeConversionException
	{
		Class clzz = null;
		if (castTo != null) {
			try {
				...
				throw new TypeConversionException("could not get class for " + castTo);
	 ...
	 *             if the constructors of the new type
	 *             throw an exceptions.
	 * 
	 */
	public static Object convertPrim(Class type, Object value) throws TypeConversionException
	{
		if (value == null)
			return null;
