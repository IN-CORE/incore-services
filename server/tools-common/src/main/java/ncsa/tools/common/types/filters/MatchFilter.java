...
public class MatchFilter implements Filter {
    ...
    /**
     * @param b if true, negates the entire disjunction of clauses.
     */
    ...
    /**
     * @param c a match clause consisting of a conjunction of statements.
     */
     ...
     *
     * @param constraint to add to all clauses in the filter.
     */
