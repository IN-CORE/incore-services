...
public class RegExFilter implements UserFacing {
    ...
    /**
     * @param s tag demarcating the beginning of a qualifying sequence.
     */
    ...
    /**
     * @param s tag demarcating the end of a qualifying sequence.
     */
    ...
    /**
     * @param s a java.util.regex pattern to match.
     */
    ...
    /**
     * @param b true will set the matcher's flag to case-insensitive.
     */
    ...
    /**
     * @param s options: "single-line" = treat match as one line;
     *          "multiline" = treat match as multiple lines.
     * @throws NCSAException if not given one of the above options.
     */
    ...
    /**
     * @param i maximum length (in bytes) of a tag (DEFAULT = 128).
     */
    ...
    /**
     * @param i maximum length (in bytes) of a pattern
     *          (DEFAULT = 128000).
     */
    ...
    /**
     * @param b true means the tags should be returned with the
     ...
     * on another sequence.
     *
     * @param charSequence the sequence to search for match.
     ...
     *
     * @param charSequence in which to find a match.
     * @return the state flag (MATCHED, LOOKING, UNMATCHED).
     */
     ...
     *
     * @param charSequence in which to find qualifying sequence.
     * @return the state flag (MATCHED, LOOKING, UNMATCHED).
     */
