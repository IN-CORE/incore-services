...
public interface Updateable extends UserFacing {
    String ID_NAMESPACE = "ncsa.updateable.id";
    String NEW_NAMESPACE = "ncsa.updateable.new";
    String DELETED_NAMESPACE = "ncsa.updateable.deleted";
     ...
     */
    Element createUpdateableElement();
}
