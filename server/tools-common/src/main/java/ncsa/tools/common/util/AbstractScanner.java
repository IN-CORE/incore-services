...
public abstract class AbstractScanner {
    ...
    /**
     * @param b if true, returned ListResult will contain listings which
    ...
    /**
     * @param b if true, returned ListResult will contain listings which do
    ...
    /**
     * @param b if true, sorts in descending order (default = false).
     */
     ...
     *
     * @param b if true, stores full metadata object; else stores only the
    ...
    /**
     * @param b if true, and the file or directory does not exist,
    ...
    /**
     * @param b if true, matching is case sensitive (default = true).
     */
     ...
     *
     * @param includes array of exclude patterns. May be <code>null</code>.
     ...
     *
     * @param excludes array of exclude patterns. May be <code>null</code>.
     *                 If a non-<code>null</code> array is
     *                 given, all elements must be non-<code>null</code>.
     */
