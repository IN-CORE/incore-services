...
public class ReflectUtils
{
	...
	/**
	 * @param methodName
	 *            of null parameter method to invoke.
	 * @param target
	...
	/**
	 * @param method
	 *            array of methods to try to invoke. returns on first successful
	 *            invocation
	 * @param target
	 *            object on which to invoke.
	 * @param pvalues
	...
	/**
	 * @param fqn
	 *            of object to be constructed.
	 * @param ptypes
	 *            classes of constructor's parameters.
	 * @param pvalues
	 *            parameter values.
	...
	/**
	 * @param type
	 *            class of object to be constructed.
	 * @param ptypes
	 *            classes of constructor's parameters.
	 * @param pvalues
	 *            parameter values.
	 ...
	 * 
	 * @param prefix
	 *            e.g., "add, create, get, set, etc.".
	 * @param name
	 *            usually corresponds to the attribute or element name.
	...
	/**
	 * @param clzz
	 *            class of object in question.
	 * @param name
	 *            of method in question.
	 * @param ptypes
	...
	/**
	 * @param value
	 *            presumably indexed object.
	 * @return numerical wrapper representing size.
	 * @throws ReflectionException
	 *             if value is null or not an Array or List.
	 */
	 ...
	 * 
	 * @param clzz
	 *            Class for which to derive a tag.
	 ...
	 * 
	 * @param clzz
	 *            to check for implementation of interfaces.
	 ...
	 * 
	 * @param clzz
	 *            class of object to be inspected.
	 * @param full
	 *            if true, searches superclasses up to but excluding Object.
	 ...
	 * @param singleParam
	 *            if true, looks for 1-parameter methods; if false,
	 *            0-parameter methods.
	 * @param full
	 *            if true, all superclasses excluding Object will be searched.
	 * @return array of two-member String arrays containing the
	 *         normalized name (first letter after prefix changed to lower
	 ...
	 *            string to match.
	 * @param numParams
	 *            number of parameters on method.
	 * @param full
	 *            if true, all superclasses excluding Object will be searched.
