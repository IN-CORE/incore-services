...
public class Dfr3Mapper {
    ...
    public String getDfr3CurveFor(String schema, Map<String, Object> row, Map<String, Object> params) {
        //get all possible mapping sets that we know about for this schema
        //for each one, look at each dfr3 mapping set, see which is "best"
