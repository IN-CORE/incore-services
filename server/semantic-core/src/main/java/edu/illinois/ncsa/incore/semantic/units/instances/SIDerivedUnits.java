...
public final class SIDerivedUnits {
    ...
    public static final DivisionDerivedUnit cubicMetrePerSecond = new DivisionDerivedUnit(cubicMetre, SIUnits.second, Dimensions.volumetricFlow);

    public static final DivisionDerivedUnit metrePerSecondSquared = new DivisionDerivedUnit(SIUnits.metre, squareSecond, Dimensions.acceleration);
    ...
    public static final DivisionDerivedUnit metrePerQuarticSecond = new DivisionDerivedUnit(SIUnits.metre, quarticSecond, Dimensions.jounce);
    ...
    public static final DivisionDerivedUnit radianPerSecondSquared = new DivisionDerivedUnit(radian, squareSecond, Dimensions.angularAcceleration);
    ...
    public static final ProductDerivedUnit newtonMetreSecond = new ProductDerivedUnit(newtonMetre, SIUnits.second, Dimensions.angularMomentum);
    ...
    public static final DivisionDerivedUnit kilogramPerSquareMetre = new DivisionDerivedUnit(SIUnits.kilogram, squareMetre, Dimensions.areaDensity);

    public static final DivisionDerivedUnit kilogramPerCubicMetre = new DivisionDerivedUnit(SIUnits.kilogram, cubicMetre, Dimensions.density);

    public static final DivisionDerivedUnit cubicMetrePerKilogram = new DivisionDerivedUnit(cubicMetre, SIUnits.kilogram, Dimensions.specificVolume);
    ...
    public static final DivisionDerivedUnit joulePerKelvinKilogram = new DivisionDerivedUnit(joulePerKelvin, kilogram, Dimensions.heatCapacity);
    ...
    public static final DivisionDerivedUnit weberPerMetre = new DivisionDerivedUnit(weber, SIUnits.metre, Dimensions.magneticVectorPotential);
    ...
    public static final DivisionDerivedUnit cubicMetrePerMoleSecond = new DivisionDerivedUnit(cubicMetre, moleSecond, Dimensions.catalyticEfficiency);

    public static final ProductDerivedUnit kilogramSquareMetre = new ProductDerivedUnit(SIUnits.kilogram, squareMetre, Dimensions.momentOfInertia);
    ...
    public static final DivisionDerivedUnit metrePerHenry = new DivisionDerivedUnit(SIUnits.metre, henry, Dimensions.magneticSusceptibility);
    ...
    public static final DivisionDerivedUnit wattPerSteradianMetre = new DivisionDerivedUnit(wattPerSteradian, metre, Dimensions.spectralIntensity);

    public static final DivisionDerivedUnit wattPerSteradianSquareMetre = new DivisionDerivedUnit(wattPerSteradian, squareMetre,  Dimensions.radiance);

    public static final DivisionDerivedUnit wattPerSteradianCubicMetre = new DivisionDerivedUnit(wattPerSteradian, cubicMetre, Dimensions.spectralRadiance);
