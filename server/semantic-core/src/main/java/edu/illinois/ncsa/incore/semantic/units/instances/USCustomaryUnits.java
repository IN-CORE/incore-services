...
public final class USCustomaryUnits {
    ...
    // Aliases
    public static final NamedUnit gallon = liquidGallon;
    public static final NamedUnit foot = ImperialUnits.foot;

    public static final List<Unit> All = Arrays.asList(point, pica, link, surveyFoot, rod, surveyMile, section, surveyTownship, squareFoot,
        squareChain, cubicInch, cubicFoot, cubicYard, minim, fluidDram, teaspoon, tablespoon,
        fluidOunce, shot, gill, cup, liquidPint, liquidQuart, liquidGallon, liquidBarrel,
        oilBarrel, hogshead, dryPint, dryQuart, dryGallon, peck, bushel, dryBarrel,
        pennyweight, troyOunce, troyPound);
}
