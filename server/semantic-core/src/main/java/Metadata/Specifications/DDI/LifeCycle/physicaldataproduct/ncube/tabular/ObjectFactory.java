 ...
 * generated in the ddi.physicaldataproduct_ncube_tabular package.
...
public class ObjectFactory {
    ...
    private final static QName _RecordLayout_QNAME = new QName("ddi:physicaldataproduct_ncube_tabular:3_2", "RecordLayout");
    private final static QName _TopLeftTableAnchor_QNAME = new QName("ddi:physicaldataproduct_ncube_tabular:3_2", "TopLeftTableAnchor");
    private final static QName _PhysicalTableLocation_QNAME = new QName("ddi:physicaldataproduct_ncube_tabular:3_2",
                                                                        "PhysicalTableLocation");
    private final static QName _AttachedAttribute_QNAME = new QName("ddi:physicaldataproduct_ncube_tabular:3_2", "AttachedAttribute");
    private final static QName _NCubeInstance_QNAME = new QName("ddi:physicaldataproduct_ncube_tabular:3_2", "NCubeInstance");
    private final static QName _DataItem_QNAME = new QName("ddi:physicaldataproduct_ncube_tabular:3_2", "DataItem");
    private final static QName _Measure_QNAME = new QName("ddi:physicaldataproduct_ncube_tabular:3_2", "Measure");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ddi.physicaldataproduct_ncube_tabular
     */
     ...
     */
    @XmlElementDecl(namespace = "ddi:physicaldataproduct_ncube_tabular:3_2", name = "RecordLayout", substitutionHeadNamespace = "ddi:physicaldataproduct:3_2", substitutionHeadName = "BaseRecordLayout")
     ...
     */
    @XmlElementDecl(namespace = "ddi:physicaldataproduct_ncube_tabular:3_2", name = "TopLeftTableAnchor")
     ...
     */
    @XmlElementDecl(namespace = "ddi:physicaldataproduct_ncube_tabular:3_2", name = "PhysicalTableLocation")
     ...
     */
    @XmlElementDecl(namespace = "ddi:physicaldataproduct_ncube_tabular:3_2", name = "AttachedAttribute")
     ...
     */
    @XmlElementDecl(namespace = "ddi:physicaldataproduct_ncube_tabular:3_2", name = "NCubeInstance")
     ...
     */
    @XmlElementDecl(namespace = "ddi:physicaldataproduct_ncube_tabular:3_2", name = "DataItem")
     ...
     */
    @XmlElementDecl(namespace = "ddi:physicaldataproduct_ncube_tabular:3_2", name = "Measure")
