...
public class NCSAOutputPipe extends OutputStream
{
	...
	/**
	 * @param b
	 *            if true, this stream represents an error stream.
	 */
	...
	/**
	 * @param b
	 *            if true, log message as INFO or ERROR (if an error stream).
	 */
	...
	/**
	 * @param b
	 *            if true, append to the indicated file (default=false).
	 */
	 ...
	 * 
	 * @param bigbyte
	 *            int representation of a byte to write.
	 * @throws IOException
	 *             if output exceeds memory, or if the
